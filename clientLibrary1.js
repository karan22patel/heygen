...
//library with constructor
/*
2 urls were used with the situation in mind in 
which a process is initially triggered via URL1 
and then checked with URL2

*/
class ClientLibrary {
    constructor(apiURL, apiURL2) {
        this.apiURL = apiURL;
